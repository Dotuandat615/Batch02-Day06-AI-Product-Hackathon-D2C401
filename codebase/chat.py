...
def run_model_tool_loop(
    *,
    ...
    for round_index in range(1, max_tool_rounds + 1):
        ...
        for call in calls:
            print(f"[TOOL] {call.name}({json.dumps(call.args, ensure_ascii=False, sort_keys=True)})", flush=True)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Interactive Food Guide Agent chat with transcript logging.")
